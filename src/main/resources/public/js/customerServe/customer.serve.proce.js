layui.use(['table','layer',"form"],function(){
    ...
    table.on("tool(customerServes)",function (obj) {
        ...
        switch (event) {
            case 'proce':
                openCustomerServeProceDialog(obj.data.id);
                break;
     ...
     * @param serveId
     */
    function openCustomerServeProceDialog(serveId) {
        var title="服务管理 - 服务处理";
        var url=ctx+"/customer_serve/toCustomerServeProcePage?serveId="+serveId;
