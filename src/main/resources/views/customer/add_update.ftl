            ...
            <div class="layui-input-block">
                ...
                <#if (customer.level)??>
                    <select name="level"  id="level">
                        ...
                        <option value="普通客户" <#if customer.level="普通客户">selected="selected"</#if>>普通客户</option>
                        <option value="重点开发客户" <#if customer.level="重点开发客户">selected="selected"</#if>>重点开发客户</option>
                        <option value="大客户" <#if customer.level="大客户">selected="selected"</#if>>大客户</option>
                        <option value="战略合作伙伴" <#if customer.level="战略合作伙伴">selected="selected"</#if> >战略合作伙伴</option>
                    </select>
                <#else>
