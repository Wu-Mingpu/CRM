    ...
    <div class="admin-login-background">
        <div class="layui-form login-form">
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    <button class="layui-btn layui-btn-fluid layui-btn layui-btn-normal" lay-submit="" lay-filter="login">登 录</button>
                </div>
            </form>
        </div>
    </div>
...
<script src="${ctx}/js/util.js" charset="utf-8"></script>
</body>
</html>